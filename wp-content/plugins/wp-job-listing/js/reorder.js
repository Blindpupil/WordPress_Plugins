    ...
    sortList.sortable({
        ...
        update: function( event, ui ) {
            ...
            $.ajax({                       //jQuery AJAX
               ...
               data: {
                   action: 'save_sort',   //this indicates what action happens when the AJAX comes through. We'll have to define the 'save_post' ourselves later.
                   order: sortList.sortable( 'toArray' ),            //custom variable we create to pass the ID's in the order in which they are
